...
regiao = st.sidebar.selectbox('Região', options = regioes)
...
query_strings = {'regiao': regiao.lower(), 'ano':ano}
...
if filtro_vendedores:
    vendedores_selecionados = dados['Vendedor'].isin(filtro_vendedores)
    dados = dados[vendedores_selecionados]
...
with aba3:
    ...
    with coluna1:
        ...
        fig_receita_vendedores.update_layout(yaxis_title = '', xaxis_title = 'Receita')
    ...
    with coluna2:
        ...
        fig_vendas_vendedores.update_layout(yaxis_title = '', xaxis_title = 'Vendas')
